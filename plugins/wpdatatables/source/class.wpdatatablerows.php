...
class WPDataTableRows
{
     ...
     */
    public function setColHeaders(array $colHeaders): void
    {
     ...
     */
    public function setColWidths(array $colWidths): void
    {
     ...
     * @return string
     */
    public function getColNumber(): string
    {
     ...
     */
    public function setColNumber(string $colNumber): void
    {
     ...
     */
    public function setRowNumber(string $rowNumber): void
    {
     ...
     */
    public function setRowsData(array $rowsData): void
    {
     ...
     * @return string
     */
    public function getCellData(): string
    {
     ...
     */
    public function setCellData(string $cellData): void
    {
     ...
     * @return bool
     */
    public function isHiddenCell(): bool
    {
     ...
     */
    public function setHiddenCell(bool $hiddenCell): void
    {
     ...
     * @return array
     */
    public function getCellMetaData(): array
    {
     ...
     */
    public function setCellMetaData(array $cellMetaData): void
    {
     ...
     */
    public function setReloadCounter(int $reloadCounter): void
    {
     ...
     */
    public function setTableSettingsData($tableSettingsData): void
    {
     ...
     * @param int $tableID
     */
    public function saveTableWithEmptyData(int $tableID)
    {
        $tempRows = [];
     ...
     * @param int $tableID
     */
    public function deleteRowsData(int $tableID)
    {
        global $wpdb;
        $wpdb->delete(
     ...
     * @param int $tableID
     */
    public function checkIsExistTableID(int $tableID)
    {
        global $wpdb;
        return $wpdb->get_var(
            $wpdb->prepare(
