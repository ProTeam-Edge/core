              ...
              if (expectedTypes.length > 1) {
                ...
                $.each(expectedTypes, function(index, type) {
                  ...
                  var typeIsHidden = hiddenTopicsOnLoad.includes("hidden_topic_"+type.slice(18));
                    ...
                    out += "<tr class='propertyTable'>else parent<td class='" + first_level_propertyClass + "'><input type='checkbox' class='" + d.TopicName + " subpropertycheckbox' onclick='return child_settings_trigger(this)'  id='" + d.TopicName.toLowerCase() + "_" + item["Label"].toLowerCase() + "_" + type.slice(18).toLowerCase() + "'></td><td>" + item["Label"] + "</td><td>" + item["Comment"] + "</td>";
