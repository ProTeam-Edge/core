...
<div class="page-header" style='margin: 0 -15px 0 -15px; padding: 0; height: 0.75in;'>
		...
		<div style='width: 50%; height: 0.1875in; background-color: <?php echo $highlightColor; ?>; margin-left: auto; margin-right: auto; '></div>
		<div style='width: 100%; height: 0.1875in;  background-color: <?php echo $highlightColor; ?>'></div>
