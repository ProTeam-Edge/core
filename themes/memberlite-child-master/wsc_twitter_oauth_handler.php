...
if (isset($_REQUEST['oauth_token'])) {
	...
	if ($request_token) {
		...
		if ($access_token) {
			...
			vit_store_kvp($request_token['oauth_token'], $access_token);

			$twitterScreenName = $access_token['screen_name'];
			$message = "Hi @{$twitterScreenName}, you're all set!<br><br>Please close this browser window to Mint your Fungie NFT.";
		...
		alpn_log("EXTENDED TWITTER AUTH");
