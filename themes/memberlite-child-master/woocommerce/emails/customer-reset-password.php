...
<p><?php printf( esc_html__( 'Hi,' ) ); ?></p>
<?php	$emailObj = $args['email']; $emailAddress = $emailObj->user_email; ?>
...
<?php /* translators: %s: Customer username */ ?>
<p><?php printf( esc_html__( 'Email: %s', 'woocommerce' ), esc_html( $emailAddress ) ); ?></p>
