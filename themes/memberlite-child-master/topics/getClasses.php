...
foreach ($data["@graph"] as $value) {
  ...
  if ($value["@type"] == "rdfs:Class") {
    ...
    $temp["HiddenTopic"] = "&nbsp;";
    $temp["extra_fields"] = "<textarea placeholder='alpn_about_source' class='all_area' data='alpn_about_source' rel='".substr($value["@id"], 18)."'></textarea></br><textarea  placeholder='alpn_name_source' class='all_area' data='alpn_name_source' rel='".substr($value["@id"], 18)."'></textarea>";
