...
$topicFile = WP_CONTENT_DIR . "/themes/memberlite-child-master/jonathan_dev/generatedTopics/" . $topicVar . "_main.json"; //Person_form.json";
      ...
      if ($value["hidden"] == "false") {
        ...
        if ($typeSplit[0] != "core") { // Don't include core types
          ...
          if (true) {
            ...
            $temp["css"] = "wpforms-one-half wpforms-first";
